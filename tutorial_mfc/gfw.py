...
def plot_primal_gap(list_gap : list):
    ...
    plt.grid()
    path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'..','output','mfc','figures','upper_bound_primal_gap.png' )
    plt.savefig(path)
    plt.show()
    plt.close()
...
def plot_log_primal_gap(list_gap : list):
    ...
    plt.legend(loc='center right')
    plt.grid()
    path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'..','output','mfc','figures','log_log_upper_bound_primal_gap.png' )
    plt.savefig(path)
    plt.show()
    plt.close()
